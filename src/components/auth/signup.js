    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4">
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-lg w-full max-w-md">
                ...
                <p className="mt-4 flex text-center justify-between">
                    <a
                        href="/login"
                    ...
                    <a
                        onClick={async () => resendVerificationEmail(email)}
                        className="text-blue-500 hover:underline w-1/2 cursor-pointer"
                    >
                        Resened verification email
                    </a>
                </p>
            </div>
        </div>
